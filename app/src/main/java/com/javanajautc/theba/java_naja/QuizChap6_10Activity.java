...
public class QuizChap6_10Activity extends AppCompatActivity {

    private QuizChapter6 mQuiz = new QuizChapter6();
    ...
    private int mScore;
    private int mQuizNumber = 9;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_chap6_10);
        ...
        current_user_db_score.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                updateQuiz();
                //Toast.makeText(QuizChap6_10Activity.this,""+mScore,Toast.LENGTH_SHORT).show();
            }
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice1.getText() == mAnwser){
                    ...
                    Toast.makeText(QuizChap6_10Activity.this,"คำตอบถูกต้อง",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizChap6_10Activity.this,"คำตอบไม่ถูกต้อง",Toast.LENGTH_SHORT).show();
                    finish();
                    updateQuiz();
                }
            }
    ...
    private void updateQuiz(){
        ...
        if (mScore >= 69){
            ...
            Intent intent = new Intent(QuizChap6_10Activity.this, QuizTrueFalse_Chap6Activity.class);
            finish();
