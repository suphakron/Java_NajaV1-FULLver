...
public class QuizChap2_5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current_user_db_score.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                updateQuiz();
                //Toast.makeText(QuizChap2_5Activity.this,""+mScore,Toast.LENGTH_SHORT).show();
            }
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice1.getText() == mAnwser){
                    ...
                    Toast.makeText(QuizChap2_5Activity.this,"คำตอบถูกต้อง",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizChap2_5Activity.this,"คำตอบไม่ถูกต้อง",Toast.LENGTH_SHORT).show();
                    finish();
                    updateQuiz();
                }
            }
    ...
    private void updateQuiz(){
        ...
        if (mScore >= 8){
            ...
            Intent intent = new Intent(QuizChap2_5Activity.this, Chap2_6Activity.class);
            finish();
