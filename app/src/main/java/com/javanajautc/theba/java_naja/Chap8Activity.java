...
public class Chap8Activity extends AppCompatActivity
    ...
    private int mScore;
    private Button button_chap8_1, button_chap8_2, button_chap8_3, button_chap8_4, button_chap8_5;
    private TextView tv;
                    ...
                    current_user_db_score.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (mScore == 89){
                                ...
                                button_chap8_3.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                button_chap8_4.setEnabled(true);
                                button_chap8_4.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                ...
                                button_chap8_1.setTextColor(Color.parseColor("#80000000"));
                                button_chap8_2.setEnabled(false);
                                button_chap8_2.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap8_2.setTextColor(Color.parseColor("#80000000"));
                                button_chap8_3.setEnabled(false);
                                button_chap8_3.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap8_3.setTextColor(Color.parseColor("#80000000"));
                                button_chap8_4.setEnabled(false);
                                button_chap8_4.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap8_4.setTextColor(Color.parseColor("#80000000"));
                                button_chap8_5.setEnabled(false);
...
//            img_profile.setImageBitmap(Bitmap);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() == null){
                    ...
                    startActivity(new Intent(Chap8Activity.this, LoginActivity.class));
                }
            }
        };

        button_chap8_1 = (Button) findViewById(R.id.img_Button1);

        button_chap8_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter8_1 = new Intent(Chap8Activity.this,Chap8_1Activity.class);
                startActivity(Chapter8_1);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap8_2 = (Button) findViewById(R.id.img_Button2);

        button_chap8_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter8_2 = new Intent(Chap8Activity.this,Chap8_2Activity.class);
                startActivity(Chapter8_2);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap8_3 = (Button) findViewById(R.id.img_Button3);
        button_chap8_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter8_3 = new Intent(Chap8Activity.this,Chap8_3Activity.class);
                startActivity(Chapter8_3);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap8_4 = (Button) findViewById(R.id.img_Button4);
        ...
        button_chap8_5 = (Button) findViewById(R.id.img_Button5);
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_HOME) {
            Intent intent = new Intent(Chap8Activity.this, MainActivity.class);
            ...
            startActivity(new Intent(Chap8Activity.this,EditProfileActivity.class));
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        } else if (id == R.id.nav_Achievement) {

            startActivity(new Intent(Chap8Activity.this,AchievementActivity.class));
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
