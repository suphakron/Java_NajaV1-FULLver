...
public class QuizChap1_2Activity extends AppCompatActivity {
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice1.getText() == mAnwser){
                    ...
                    Toast.makeText(QuizChap1_2Activity.this,"คำตอบถูกต้อง",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizChap1_2Activity.this,"คำตอบไม่ถูกต้อง",Toast.LENGTH_SHORT).show();
                    updateQuiz();
                }
            }
        });
    ...
    private void updateQuiz(){
        ...
        if (mScore >= 2){
            ...
            Intent intent = new Intent(QuizChap1_2Activity.this, Chap1_3Activity.class);
            finish();
