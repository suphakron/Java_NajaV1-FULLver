...
public class Chap4Activity extends AppCompatActivity
    ...
    private int mScore;
    private Button button_chap4_1, button_chap4_2, button_chap4_3, button_chap4_4, button_chap4_5;
    private TextView tv;
                    ...
                    current_user_db_score.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (mScore >= 28 && mScore < 30){
                                ...
                                button_chap4_2.setTextColor(Color.parseColor("#80000000"));
                                button_chap4_3.setEnabled(false);
                                button_chap4_3.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_3.setTextColor(Color.parseColor("#80000000"));
                                button_chap4_4.setEnabled(false);
                                button_chap4_4.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_4.setTextColor(Color.parseColor("#80000000"));
                                ...
                                button_chap4_2.setEnabled(true);
                                button_chap4_2.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_3.setEnabled(true);
                                button_chap4_3.getBackground().setColorFilter(Color.parseColor("#bebcbc"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_4.setEnabled(false);
                                button_chap4_4.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_4.setTextColor(Color.parseColor("#80000000"));
                                button_chap4_5.setEnabled(false);
                                ...
                                button_chap4_2.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_3.setEnabled(true);
                                button_chap4_3.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_4.setEnabled(true);
                                button_chap4_4.getBackground().setColorFilter(Color.parseColor("#bebcbc"), PorterDuff.Mode.MULTIPLY);
                                ...
                                button_chap4_3.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_4.setEnabled(true);
                                button_chap4_4.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                ...
                                button_chap4_4.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_5.setEnabled(true);
                                button_chap4_5.getBackground().setColorFilter(Color.parseColor("#aee663"), PorterDuff.Mode.MULTIPLY);

                            }  else {
                                button_chap4_1.setEnabled(false);
                                button_chap4_1.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_1.setTextColor(Color.parseColor("#80000000"));
                                button_chap4_2.setEnabled(false);
                                button_chap4_2.getBackground().setColorFilter(Color.parseColor("#e3e3e3"), PorterDuff.Mode.MULTIPLY);
                                button_chap4_2.setTextColor(Color.parseColor("#80000000"));
                                button_chap4_3.setEnabled(false);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() == null){
                    ...
                    startActivity(new Intent(Chap4Activity.this, LoginActivity.class));
                }
            }
        };

        button_chap4_1 = (Button) findViewById(R.id.img_Button1);

        button_chap4_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter4_1 = new Intent(Chap4Activity.this,Chap4_1Activity.class);
                startActivity(Chapter4_1);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap4_2 = (Button) findViewById(R.id.img_Button2);

        button_chap4_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter4_2 = new Intent(Chap4Activity.this,Chap4_2Activity.class);
                startActivity(Chapter4_2);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap4_3 = (Button) findViewById(R.id.img_Button3);
        button_chap4_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter4_3 = new Intent(Chap4Activity.this,Chap4_3Activity.class);
                startActivity(Chapter4_3);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap4_4 = (Button) findViewById(R.id.img_Button4);

        button_chap4_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter4_4 = new Intent(Chap4Activity.this,Chap4_4Activity.class);
                startActivity(Chapter4_4);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        button_chap4_5 = (Button) findViewById(R.id.img_Button5);

        button_chap4_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Chapter4_5 = new Intent(Chap4Activity.this,Chap4_5Activity.class);
                startActivity(Chapter4_5);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_HOME) {
            Intent intent = new Intent(Chap4Activity.this, MainActivity.class);
            ...
            startActivity(new Intent(Chap4Activity.this,EditProfileActivity.class));
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        } else if (id == R.id.nav_Achievement) {

            startActivity(new Intent(Chap4Activity.this,AchievementActivity.class));
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
...
//                y2 = Touchevent.getY();
//                if (x1 < x2) {
//                    Intent i = new Intent(Chap4Activity.this, MainActivity.class);
//                    startActivity(i);
//                }
//                break;
//        }
