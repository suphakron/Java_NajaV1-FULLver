...
public class QuizChap4_9Activity extends AppCompatActivity {
    ...
    private int mScore;
    private int mQuizNumber = 8;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_chap4_9);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice1.getText() == mAnwser){
                    ...
                    Toast.makeText(QuizChap4_9Activity.this,"คำตอบถูกต้อง",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizChap4_9Activity.this,"คำตอบไม่ถูกต้อง",Toast.LENGTH_SHORT).show();
                    finish();
                    updateQuiz();
                }
            }
    ...
    private void updateQuiz(){
        ...
        if (mScore >= 37){
            ...
            Intent intent = new Intent(QuizChap4_9Activity.this, QuizChap4_10Activity.class);
            finish();
