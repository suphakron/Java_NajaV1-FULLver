...
public class Achieve_Chap3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achieve__chap3);
...
//                }
                if (score == 1) {
                    ...
                    star5.setImageResource(R.drawable.star);
                    star6.setImageResource(R.drawable.star);
                    star7.setImageResource(R.drawable.star);
                    txt_total.setText(score + "/14");
                    ...
                    star6.setImageResource(R.drawable.star);
                    star7.setImageResource(R.drawable.star);
                    star8.setImageResource(R.drawable.star);
                    txt_total.setText(score + "/14");
                    ...
                    star7.setImageResource(R.drawable.star);
                    star8.setImageResource(R.drawable.star);
                    star9.setImageResource(R.drawable.star);
                    txt_total.setText(score+"/14");
                } else if (score >= 14){
                    star.setImageResource(R.drawable.star);
                    star2.setImageResource(R.drawable.star);
                    ...
                    star8.setImageResource(R.drawable.star);
                    star9.setImageResource(R.drawable.star);
                    star10.setImageResource(R.drawable.star);
                    txt_total.setText("14/14");
                }
            }
