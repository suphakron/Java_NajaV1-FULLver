...
public class QuizTrueFalse_Chap6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_true_false_chap6);
        ...
        current_user_db_score.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                updateQuiz();
                //Toast.makeText(QuizChap6_5Activity.this,""+mScore,Toast.LENGTH_SHORT).show();
            }
        ...
        mTrueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mAnswer == true){
                    ...
                    Toast.makeText(QuizTrueFalse_Chap6Activity.this,"คำตอบถูกต้อง",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizTrueFalse_Chap6Activity.this,"คำตอบไม่ถูกต้อง",Toast.LENGTH_SHORT).show();
                    finish();
                    updateQuiz();
                }
            }
    ...
    private void updateQuiz(){
        ...
        if (mScore == 76) {
            ...
            Intent intent = new Intent(QuizTrueFalse_Chap6Activity.this, Chap6Activity.class);
            finish();
        ...
        mQuestion.setText(Quiz_True_False_Chap6.questions[mQuizNumber]);
        mAnswer = Quiz_True_False_Chap6.answers[mQuizNumber];
