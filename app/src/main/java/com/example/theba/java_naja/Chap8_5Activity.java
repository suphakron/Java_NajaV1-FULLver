...
public class Chap8_5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chap8_5);
        ...
        Nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Next = new Intent(Chap8_5Activity.this, QuizChap8_4Activity.class);
                startActivity(Next);
...
// if right to left sweep event on screen
                if (x1 > x2) {
                    ...
                    Intent i = new Intent(Chap8_5Activity.this, QuizChap8_4Activity.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                }
