...
public class QuizChap3_5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_chap3_5);
        ...
        current_user_db_score.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                updateQuiz();
                //Toast.makeText(QuizChap3_5Activity.this,""+mScore,Toast.LENGTH_SHORT).show();
            }
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice1.getText() == mAnwser){
                    ...
                    Toast.makeText(QuizChap3_5Activity.this,"คำตอบถูกต้อง",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizChap3_5Activity.this,"คำตอบไม่ถูกต้อง",Toast.LENGTH_SHORT).show();
                    finish();
                    updateQuiz();
                }
            }
    ...
    private void updateQuiz(){
        ...
        if (mScore >= 19){
            ...
            Intent intent = new Intent(QuizChap3_5Activity.this, Chap3_6Activity.class);
            finish();
